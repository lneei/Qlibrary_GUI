...
public:
    ...
    void setupUi(QDialog *Dlg_BookGS)
    {
        ...
        lb_name->setMaximumSize(QSize(16777215, 60));

        gridLayout_2->addWidget(lb_name, 0, 1, 1, 1);

        label_2 = new QLabel(Dlg_BookGS);
        ...
        le_password = new QLineEdit(Dlg_BookGS);
    ...
    void retranslateUi(QDialog *Dlg_BookGS)
    {
        ...
        lb_name->setText(QCoreApplication::translate("Dlg_BookGS", "XXX", nullptr));
        label_2->setText(QCoreApplication::translate("Dlg_BookGS", "\347\224\250\346\210\267\345\220\215", nullptr));
        label_3->setText(QCoreApplication::translate("Dlg_BookGS", "\345\257\206\347\240\201", nullptr));
        btn_get->setText(QCoreApplication::translate("Dlg_BookGS", "\345\200\237\351\230\205/\345\275\222\350\277\230", nullptr));
